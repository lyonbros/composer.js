 ...
 */
(function(){"use strict";if(!this.Composer){var Composer={version:'1.3.3',exp0rt:function(obj){Object.keys(obj).forEach(function(key){Composer[key]=obj[key];});}};this.Composer=Composer;}
...
var id_key=(new this.model()).id_key;data.forEach(function(item){var id=item[id_key];data_id_map[id]=true;});var missing=[];this.each(function(m){var mid=m.id();if(!data_id_map[mid])missing.push(mid);});var remove_list=missing.map(function(mid){return this.get(mid);}.bind(this));this.remove(remove_list);}
